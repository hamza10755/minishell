...
/*   Updated: 2025/03/15 18:11:28 by hamzabillah      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int     expand_var(const char *input, int *i, char **buffer, size_t *pos, size_t *cap, char **env);
...
void    handle_whitespace(int *i, char *buffer, size_t *j, t_token **tokens, int *in_word);
